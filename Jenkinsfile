                ...
                stage("Deploy On AWS EC2 Instance"){
                    steps{
                        ...
                        def remote = [:]
                            ...
                            sshCommand remote: remote, command: 'docker container kill $(docker ps -q)'
                            ...
                            sshCommand remote: remote, command: "docker run -d -p 8080:8282 --name auction arthur2104/auction"
